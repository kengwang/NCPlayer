...
{
    private static readonly byte[] _flag = [0x43, 0x54, 0x45, 0x4e, 0x46, 0x44, 0x41, 0x4d];

    private static byte[] _id3Flag = [0x49, 0x44, 0x33];
    private static byte[] _pngFlag = [0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A];

    private static readonly byte[] _coreBoxKey = [0x68, 0x7A, 0x48, 0x52, 0x41, 0x6D, 0x73, 0x6F, 0x35, 0x6B, 0x49, 0x6E, 0x62, 0x61, 0x78, 0x57
    ];

    private static readonly byte[] _modifyBoxKey = [0x23, 0x31, 0x34, 0x6C, 0x6A, 0x6B, 0x5F, 0x21, 0x5C, 0x5D, 0x26, 0x30, 0x55, 0x3C, 0x27, 0x28
    ];
